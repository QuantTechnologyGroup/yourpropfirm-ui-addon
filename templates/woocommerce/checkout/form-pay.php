...
<form id="order_review" method="post">
	...
	<table class="shop_table">
		<thead>
			<tr>
				<th class="product-name"><?php esc_html_e( 'Product', 'yourpropfirm-ui-addon' ); ?></th>
				<th class="product-quantity"><?php esc_html_e( 'Qty', 'yourpropfirm-ui-addon' ); ?></th>
				<th class="product-total"><?php esc_html_e( 'Totals', 'yourpropfirm-ui-addon' ); ?></th>
			</tr>
		</thead>
		<tbody>
				...
				<?php foreach ( $order->get_items() as $item_id => $item ) : ?>
					...
					<tr
						...
						<td class="product-name">
							<?php
							$_ypf_pay_name = yourpropfirm_get_product_display_name( $item->get_product_id() ) ?: $item->get_name();
							echo wp_kses_post( apply_filters( 'woocommerce_order_item_name', $_ypf_pay_name, $item, false ) );
